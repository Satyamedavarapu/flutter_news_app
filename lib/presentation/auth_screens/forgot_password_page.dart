              ...
              child: SvgPicture.asset('assets/forgot.svg'),
               ...
               Expanded(flex:5, child: Card( 
                 ...
                 const  Padding(
                     ...
                     child:   Text('Password Reset Link will be sent to Email',
                     maxLines: 2,
                     overflow: TextOverflow.ellipsis,
                      style: TextStyle(color: Colors.black),),
                   ),
                   utilWidgets.userNameField(userController: userController, fieldName: 'Email'),
                   utilWidgets.cupButton(context: context, buttonName: 'Submit', onTap: () {
